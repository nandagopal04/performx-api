...
/**
 * Defines standardized message codes and message templates
 * used across the PerformX application for logging, exception handling,
 * and API responses.
 *
 * <p>Each enum constant includes:
 * <ul>
